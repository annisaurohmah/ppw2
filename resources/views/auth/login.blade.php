...
@section('menubar')
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="{{ route('register') }}" class="navbar-nav ms-lg-3 d-sm-block btn btn-primary-gradient rounded-pill py-2 px-4 d-sm-block d-lg-block {{ (request()->is('register')) ? 'active' : '' }}">Register</a> 
                </div>
@endsection
